...
export default function LoginPage() {
  ...
  return (
    <AuthShell
      title="Welcome back"
      subtitle="Sign in to continue writing, editing, and exporting your documents."
      sideTitle="A clearer workspace for your document flow."
      sideCopy="Your account gives you quick access to drafts, templates, version history, and export tools from one clean dashboard."
      footer={
        <>
