...
export async function POST(req: NextRequest) {
  try {
    ...
    // Generate content
    const rawContent = await generateStructuredContent(topic, instructions, tone, docType, requirements);
    const content = normalizeGeneratedContent(docType, rawContent, topic);
